...
import django_cardano.db.models.fields
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_address', django_cardano.db.models.fields.CardanoAddressField(max_length=200)),
                ...
                ('stake_address', django_cardano.db.models.fields.CardanoAddressField(max_length=200)),
